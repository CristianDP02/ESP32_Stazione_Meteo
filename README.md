...
Visualizzazione: Grafici in tempo reale
Assemblaggio Hardware e Collegamenti
L'assemblaggio è realizzato su breadboard. L'ESP32 alimenta entrambi i sensori tramite il suo pin 3V3.
Come Eseguirlo
Clonare questo repository.
Installare le librerie necessarie nell'Arduino IDE (vedi include nel codice).
Creare un file credentials.h nella stessa cartella dello sketch. Questo file è ignorato da Git per proteggere i dati sensibili.Incollare nel file credentials.h il seguente contenuto, sostituendo i valori:
